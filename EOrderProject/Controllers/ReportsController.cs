...
namespace EOrderProject.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Surname,Issues,Suggestion")] Reports reports)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Surname,Issues,Suggestion")] Reports reports)
        {
            if (id != reports.Id)
            {
                return NotFound();
