...
namespace EOrderProject.Data.Migrations
{
    ...
    [Migration("20230208213234_reports")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EOrderProject.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("EOrderProject.Models.ComingSoon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EOrderProject.Models.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EOrderProject.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EOrderProject.Models.Reports", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EOrderProject.Models.Restauranti", b =>
                {
                    ...
                    b.ToTable("Restaurantis");
                });

            modelBuilder.Entity("EOrderProject.Models.ShoppingCartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EOrderProject.Models.Order", b =>
                {
                    b.HasOne("EOrderProject.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("EOrderProject.Models.OrderItem", b =>
                {
                    b.HasOne("EOrderProject.Models.Menu", "Menu")
                        .WithMany()
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EOrderProject.Models.Order", "Order")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("EOrderProject.Models.Restauranti", b =>
                {
                    b.HasOne("EOrderProject.Models.Pikat", "Pikas")
                        .WithMany()
                        .HasForeignKey("PikatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("EOrderProject.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
